Pod::Spec.new do |spec|
  ...
  spec.summary      = 'iOS Class for forward geocode and reverse geocode user current location using a block-based syntax. It can also be used to know the user\'s approximate location (always country, almost always city) without asking for permission (GeoIP).'
